...
const createRenderer = (options) => {
    ...
    const patch = (vnode, container, parent = null) => {
        // 判断 是不是 element类型
    ...
    const processComponent = (vnode, container, parent) => {
        // 挂载组件
        mountComponent(vnode, container, parent);
    };
    const processFragment = (vnode, container, parent) => {
    ...
    const mountComponent = (vnode, container, parent) => {
...
export { createApp, createElement, createRenderer, createTextVNode, getCurrentInstance, h, inject, insert, patchProps, provide, renderSlot };
